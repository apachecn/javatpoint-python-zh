...
这本书是安东尼奥·梅莱写的。这本书对初学者和中级水平的学习者都有好处。如果有人对 [JavaScript](https://www.javatpoint.com/javascript-tutorial) 、HTML 和 Python 有基本的了解，这本书将是最好的选择。它深入涵盖了基本和高级概念，包括与芹菜和萝卜等其他技术的集成。作者解释了许多编码示例，涵盖了广泛的主题。我们可能需要 Django 官方文档来学习了解更多方法。我们可以认为这本书是关于Django的基础读物。作者假设你事先不知道Django。
