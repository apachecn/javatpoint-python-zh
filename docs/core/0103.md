...
![How to install matplotlib in Python](../Images/0c886c17969387595d59275a79b70c09.png)

*   根据您的 Python 解释器配置选择下载版本。

![How to install matplotlib in Python](../Images/5385bed998cbcdcadbda1f4c0a7ebfc4.png)
...
![How to install matplotlib in Python](../Images/7e20fc7a47de337f4735c22fc2addf17.png)
