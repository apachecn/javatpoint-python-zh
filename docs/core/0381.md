...
> 原文:[https://www . javatpoint . com/如何选择熊猫中的行-基于数据框的条件](https://www.javatpoint.com/how-to-select-rows-in-pandas-dataframe-based-on-conditions)

在本教程中，我们将学习用户如何使用 Python 基于条件选择熊猫数据框中的行。
...
使用**基本**方法从数据框中选择“百分比”大于 70 的所有行。
...
使用“ **loc[]** ”方法从数据框中选择“百分比”大于 70 的所有行。
...
使用“ **loc[]** ”方法从数据框中选择“百分比”不等于 71 的所有行。
...
使用**基本**方法，选择给定数据框中“**科目 _1** ”列值出现在“**科目 _2** 列表中的所有行。
...
使用“ **loc[]** ”方法选择给定数据框中“**主题 _1** ”列值出现在“**主题 _2** ”列表中的所有行。
...
使用“ **loc[]** ”方法选择给定数据框中“**主题 _1** ”列值不在“**主题 _2** ”列表中的所有行。
...
使用**基本**方法，从给定数据框中选择“**百分比 _1** ”等于“ **71** ”且“**主题 _1** ”出现在“**主题 _2** 列表中的所有行。
...
使用“**loc【】**”方法选择给定数据框中“百分比 _1”等于“ **71** ”且“**主题 _1** ”出现在“**主题 _2** ”列表中的所有行。
...
在本教程中，我们讨论了如何根据各种条件选择熊猫数据帧的不同行。
