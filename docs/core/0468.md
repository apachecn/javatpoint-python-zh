...
> 原文:[https://www . javatpoint . com/python 中的蛇用龟游戏模块](https://www.javatpoint.com/snake-game-in-python-using-turtle-module)
...
*   **时间:**用于计算事件发生之日起的秒数。
*   **Random:** 这是一个通过使用随机模块在 Python 中创建随机数的函数。

### 支持

下面的代码可以通过使用专门为 Python 程序设计的崇高文本应用程序轻松工作。
...
![Snake Game in Python using Turtle Module](../Images/1218e2a2aecf90b77e3cb85ba42e8265.png)
...
![Snake Game in Python using Turtle Module](../Images/fe7f86aaed9a74e770f12c5eddd6ab18.png)
