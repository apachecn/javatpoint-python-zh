...
![Arima Model in Python](../Images/c3f8ca2e2078ccf8aa05257291bb5e09.png)

其中，Y <sub>t-1</sub> 为该系列的 lag1。β <sub>1</sub> 是 lag1 的系数，是模型计算的截距项。

类似地，纯移动平均线模型是一个仅依赖滞后预测误差的模型。

![Arima Model in Python](../Images/20570a842ca147bfbf356c965c06106a.png)

其中，误差项是相应滞后的 AR 模型误差。ϵ <sub>t</sub> 和ϵ <sub>t-1</sub> 的误差来自下面给出的公式:

![Arima Model in Python](../Images/4525ef65907bf772b5f6f86f179abecb.png)
...
![Arima Model in Python](../Images/aece76a41abd102fce20bfeb1c371e41.png)
...
![Arima Model in Python](../Images/27e37a858eb688621e4dd9fffa5a249c.png)
...
![Arima Model in Python](../Images/1f1872560a6a4003da93b4618cc20944.png)
...
![Arima Model in Python](../Images/2105f5675247a5cd740fea202336a1da.png)
...
![Arima Model in Python](../Images/3bc9d54b48d9bbf6af0b95074b527a22.png)
...
![Arima Model in Python](../Images/707e5889c661089b8672fe47d62aa1f4.png)
...
![Arima Model in Python](../Images/23db4ef0492e1fa872e6b46c412d0876.png)
